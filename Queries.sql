select concat(ros.FIRST_NAME_TX,' ',ros.LAST_NAME_TX) as 'NAME', e.BAT_ID, substring(e.GAME_ID,4,4) as 'Year', e.BASE1_RUN_ID, e.BASE2_RUN_ID, e.BASE3_RUN_ID, e.BAT_DEST_ID, e.RUN1_DEST_ID, 
